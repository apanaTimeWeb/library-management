...
export function TablePagination({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-t border-border bg-bg-pageg-card">
        ...
        <div className="flex items-center gap-4">
          {onLimitChange && (
            <div className="flex items-center gap-2">
              ...
              <select
                className="h-8 rounded-md border border-border bg-bg-pageg-input px-2 text-sm text-text-primary focus:outline-none focus:ring-1 focus:ring-primary"
                value={limit}
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            <div className="flex items-center justify-center px-3 border-y border-border bg-bg-pageg-input text-sm font-semibold text-text-primary h-8 focus:z-10">
              {page} / {totalPages}
            </div>
            <Button
              variant="outline"
