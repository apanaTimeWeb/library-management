  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
      {kpiData.map((kpi) => {
        ...
        return (
          <div key={kpi.title} className="bg-card border border-border rounded-xl p-5 flex flex-col justify-between h-32">
            ...
            <div>
              ...
              <p className="text-text-primary text-xl font-bold text-text-primary leading-tight">{kpi.value}</p>
            </div>
          </div>
        );
      })}
