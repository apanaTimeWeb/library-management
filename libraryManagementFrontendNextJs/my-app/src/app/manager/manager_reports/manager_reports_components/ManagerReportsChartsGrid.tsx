...
export function ManagerReportsChartsGrid({ data }: ManagerReportsChartsGridProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      {/* Chart 1: Occupancy */}
      <div className="bg-card border border-border rounded-lg p-5 hover:shadow-lg transition-all duration-200 ease-in-out">
      ...
      <div className="lg:col-span-2 bg-card border border-border rounded-lg p-5 hover:shadow-lg transition-all duration-200 ease-in-out">
