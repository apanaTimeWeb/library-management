...
import { addEnquirySchema, type AddEnquiryFormData } from '@/app/manager/manager_crm/manager_crm_shared_components/schema';
...
export default function AddEnquiryPage() {
  ...
  const onSubmit = async (formData: AddEnquiryFormData) => {
    ...
    setTimeout(() => router.push('/manager/manager_crm/enquiries'), 600);
  };

  const handleClose = () => router.push('/manager/manager_crm/enquiries');
