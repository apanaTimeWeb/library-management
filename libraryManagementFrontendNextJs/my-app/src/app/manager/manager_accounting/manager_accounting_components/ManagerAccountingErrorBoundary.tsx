...
export class ManagerAccountingErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Manager Accounting Error:', error, errorInfo);
  }
    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 m-6 bg-danger-bg text-danger rounded-xl border border-danger/20 flex flex-col items-start gap-4">
          <h2 className="text-xl font-bold">Accounting Module Error</h2>
