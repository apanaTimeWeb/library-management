...
export default function ManagerStudentsAdmissionSuccessModal({ data, onClose }: ManagerStudentsAdmissionSuccessModalProps) {
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className="bg-bg-pageg-page w-full max-w-4xl rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200 my-auto" onClick={e => e.stopPropagation()}>

        <div className="flex items-center justify-between p-6 border-b border-border bg-bg-pageg-card">
        ...
        <div className="flex flex-col lg:flex-row gap-8 p-8 overflow-y-auto max-h-[80vh]">
          ...
          <div className="flex-1 flex flex-col gap-3 min-w-72">
            ...
            <div className="bg-bg-pageg-card border border-border rounded-xl p-5 mt-4 flex flex-col gap-3">
              {[
