  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-bg-card rounded-xl border border-border p-6 p-6 flex flex-col items-center justify-center text-center gap-4 border-dashed border-2 border-border bg-transparent hover:border-primary transition-colors cursor-pointer">
        ...
        <div className="bg-bg-card rounded-xl border border-border p-6 p-6 flex flex-col items-center justify-center text-center gap-4 border-dashed border-2 border-border bg-transparent hover:border-success transition-colors cursor-pointer">
      ...
      <div className="bg-bg-card rounded-xl border border-border p-6 p-6 mt-6">
