  ...
  return (
    <div className="mgr-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="mgr-card p-6 flex flex-col items-center justify-center text-center gap-4 border-dashed border-2 border-border bg-transparent hover:border-primary transition-colors cursor-pointer">
        ...
        <div className="mgr-card p-6 flex flex-col items-center justify-center text-center gap-4 border-dashed border-2 border-border bg-transparent hover:border-success transition-colors cursor-pointer">
          ...
          <button className="mgr-btn-primary mt-2 bg-success border-none">Start Manual Entry</button>
        </div>
      </div>
