...
export interface Shift {
  id: string; name: string; startH?: number; endH?: number; startTime?: string; endTime?: string; active?: boolean; occupancy?: number; capacity?: number; price?: number; type?: 'Morning' | 'Evening' | 'Night' | 'Full Day';
}

export interface Student {
  id: string; name: string; currentShift: string; targetShift: string; status: 'Pending' | 'Approved' | 'Conflict';
  validTill?: string; currentSeat?: string; plan?: string; smartId?: string; dailyRate?: number;
}
