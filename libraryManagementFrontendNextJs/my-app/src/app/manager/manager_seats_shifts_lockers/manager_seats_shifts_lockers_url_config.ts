// RESPONSIBILITY: Centralized URL routing configuration for Manager Seats, Shifts, and Lockers module.
export const MANAGER_SEATS_ROUTES = {
  ...
  SHIFT_MANAGEMENT: '/manager/manager_seats_shifts_lockers/shift-management',
