...
export const SUPERADMIN_AUDIT_LOGS_MOCK_DATA: SuperadminAuditLog[] = [
  { id: 'log_99123', time: '11 Apr 2026, 14:30', user: 'Super Admin',  entity: 'Subscription',   target: 'City Reading Hub',    action: 'Created',       ip: '192.168.1.42', detail: 'New Enterprise (Annual) subscription created for City Reading Hub. Amount: â‚¹15,000.' },
  ...
  { id: 'log_99119', time: '05 Apr 2026, 16:05', user: 'Super Admin',  entity: 'Plan',           target: 'Enterprise (Annual)', action: 'Created',       ip: '192.168.1.42', detail: 'New SaaS plan "Enterprise (Annual)" created. Price: â‚¹15,000/year. Max seats: 200.' },
