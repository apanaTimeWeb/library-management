...
export function SuperadminAuditLogsPanel({ log, onClose }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-end" onClick={onClose}>
      ...
      <div 
        className="relative w-full max-w-md bg-card shadow-[-10px_0_30px_rgba(0,0,0,0.1)] border-l border-border overflow-y-auto animate-in slide-in-from-right duration-300 flex flex-col" 
      ...
      >
        <div className="p-6 flex-1 flex flex-col gap-6">
          <div className="flex items-start justify-between">
            ...
            <button 
              className="w-8 h-8 flex items-center justify-center rounded-md text-text-secondary hover:text-text-primary hover:bg-input transition-colors" 
              onClick={onClose}
            >
              <X size={18} />
            </button>
          ...
          <div className="bg-input rounded-lg p-5 border border-border shadow-inner">
