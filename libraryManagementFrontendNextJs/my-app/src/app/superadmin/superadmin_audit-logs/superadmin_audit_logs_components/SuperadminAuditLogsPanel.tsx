      ...
      >
        <div className="p-6 flex-1 flex flex-col gap-6">
          <div className="flex items-start justify-between">
            ...
            <button 
              className="w-8 h-8 flex items-center justify-center rounded-[var(--radius-md)] text-text-secondary hover:text-text-primary hover:bg-bg-input transition-colors" 
              onClick={onClose}
            >
              <X size={18} />
            </button>
          ...
          <div className="bg-bg-input rounded-[var(--radius-lg)] p-5 border border-border shadow-inner">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={label} className="flex flex-col gap-1.5 p-1">
                ...
                <p className="text-[13px] font-mono text-text-primary truncate">{val}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-auto pt-6 border-t border-border">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-text-disabled uppercase tracking-wider">Log Status</span>
