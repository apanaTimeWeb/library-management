...
import { SUPERADMIN_SYSTEM_MOCK_BACKUP_HISTORY } from '@/app/superadmin/superadmin_system/superadmin_system_constants/SuperadminSystemConstants';
...
export default function BackupsPage() {
  ...
  const [backups, setBackups]         = useState<BackupRecord[]>(SUPERADMIN_SYSTEM_MOCK_BACKUP_HISTORY as BackupRecord[]);
