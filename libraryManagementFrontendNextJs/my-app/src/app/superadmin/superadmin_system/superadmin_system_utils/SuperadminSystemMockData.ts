...
export const SUPERADMIN_SYSTEM_MOCK_IMPORT_PREVIEW = [
...
export const SUPERADMIN_SYSTEM_MOCK_MAINTENANCE_ASSETS = [
...
export const SUPERADMIN_SYSTEM_MOCK_POWER_ZONES = [
...
export const SUPERADMIN_SYSTEM_MOCK_POWER_ALERTS = [
...
export const SUPERADMIN_SYSTEM_MOCK_SMART_IDS_ACTIVE = [1, 2, 4, 5, 6, 9, 10, 11, 12, 15, 16, 17, 18, 19, 20];

export const SUPERADMIN_SYSTEM_MOCK_WAITLIST = [
...
export const SUPERADMIN_SYSTEM_MOCK_WHATSAPP_LOGS = [
