      ...
      {analyzed ? (
        ...
        <SuperadminCard>
          <CardContent className="py-16 flex flex-col items-center justify-center gap-3 text-center">
            ...
            <p className="text-on-surface font-medium text-lg">Run an analysis to see seat gaps</p>
            <p className="text-sm text-on-surface-variant max-w-sm">Select a date range and click "Run Gap Analysis" to visualize available slots.</p>
          </CardContent>
        </SuperadminCard>
      )}
    </div>
