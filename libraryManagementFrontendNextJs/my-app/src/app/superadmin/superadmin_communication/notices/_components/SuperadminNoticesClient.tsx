...
import { useSuperadminNoticesClient } from '@/app/superadmin/superadmin_communication/notices/_components/useSuperadminNoticesClient';
                  ...
                  {paginatedNotices.length > 0 ? (
                    paginatedNotices.map((notice, index) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold ${notice.status === 'Active' ? 'bg-success-bg text-success' : 'bg-bg-input text-text-secondary'} mt-2 inline-block`}>
