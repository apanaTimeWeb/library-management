...
export const SUPERADMIN_COMMUNICATION_MOCK_NOTIFICATIONS = [
  { id: '1', category: 'Finance',    icon: 'DollarSign', title: '5 subscriptions expire today',           description: 'Rahul, Priya, Amit, Sneha, Rohan  subscriptions end today.',                 time: '2h ago', priority: 'High',   link: '/renewals',         read: false },
  { id: '2', category: 'CRM',        icon: 'Phone', title: 'Call Rahul  enquired 3 days ago',       description: 'Rahul Sharma enquired about Morning shift. Follow up now.',                   time: '3h ago', priority: 'Medium', link: '/crm/enquiries',        read: false },
  { id: '3', category: 'Finance',    icon: 'Handshake', title: '3 Payment Promise dates hit today',      description: 'Amit Kumar, Deepak Mishra, Anita Roy promised payment today.',                time: '4h ago', priority: 'High',   link: '/payment-promises', read: false },
  { id: '4', category: 'Operations', icon: 'Armchair', title: 'Seat A-05 maintenance overdue 45 days',  description: 'Last maintenance was on 2026-02-25. Immediate attention required.',           time: '1d ago', priority: 'Medium', link: '/system/maintenance',      read: false },
  { id: '5', category: 'Attendance', icon: 'Calendar', title: 'Sneha Patel absent 7 consecutive days',  description: 'Sneha Patel has not attended for 7 days. Parent alert recommended.',          time: '1d ago', priority: 'High',   link: '/absentee-report',  read: false },
  { id: '6', category: 'Finance',    icon: 'Clock', title: '2 late fee penalties auto-applied',      description: 'Late fees applied to Vikram Nair and Kavita Singh for overdue payments.',     time: '2d ago', priority: 'Medium', link: '/late-fees',        read: true  },
  { id: '7', category: 'Operations', icon: 'Lock', title: 'Locker L-03 issue reported',             description: 'Lock jammed on Locker L-03. Reported by student on 2026-04-08.',             time: '3d ago', priority: 'Medium', link: '/system/maintenance',      read: true  },
];

export const SUPERADMIN_COMMUNICATION_MOCK_WA_LOGS = [
...
export const SUPERADMIN_COMMUNICATION_MOCK_WA_TEMPLATES = [
  { id: 'welcome',      label: 'Welcome Message',      icon: 'Hand', body: 'Welcome to {libraryname}, {name}! Your seat {seat} is confirmed. We wish you a productive study journey.  Smart Library Team' },
  { id: 'fee_reminder', label: 'Fee Reminder',         icon: 'DollarSign', body: 'Hi {name}, your fee of ?{amount} is due on {duedate}. Please pay on time to avoid late charges.  {libraryname}' },
  { id: 'renewal',      label: 'Renewal Alert',        icon: 'Repeat', body: 'Hi {name}, your {planname} subscription expires in 3 days. Renew now to continue uninterrupted access.  {libraryname}' },
  { id: 'receipt',      label: 'Payment Receipt',      icon: 'Receipt', body: 'Dear {name}, your payment of ?{amount} has been received. Thank you! Contact us at {phone} for queries.  {libraryname}' },
  { id: 'notice',       label: 'Notice Broadcast',     icon: 'Bell', body: 'Important Notice from {libraryname}: Dear {name}, please note the following update from the library management.' },
