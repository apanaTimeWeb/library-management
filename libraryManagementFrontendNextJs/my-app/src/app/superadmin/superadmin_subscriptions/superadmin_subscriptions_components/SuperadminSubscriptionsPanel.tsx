    ...
    <div className="fixed inset-0 z-50 flex items-stretch justify-end" onClick={onClose}>
      ...
      >
        <div className="p-6 space-y-6">
          ...
          <div className="bg-bg-pageg-input rounded-md p-5 border border-border flex items-center justify-between shadow-inner">
            <div className="flex items-center gap-2 text-text-secondary">
              <IndianRupee size={16} /> <span className="text-sm font-bold uppercase tracking-wider">Monthly Value</span>
            </div>
            <span className="text-text-primaryxl font-extrabold text-primary tracking-tight">₹{sub.mrr.toLocaleString()}</span>
          </div>
          ...
          {editing ? (
            <div className="space-y-4 pt-2">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  className="flex-1 flex items-center justify-center gap-2 bg-transparent border border-border hover:bg-bg-pageg-input text-text-primary text-sm font-bold py-2.5 px-4 rounded-md transition-colors" 
