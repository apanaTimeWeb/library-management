  ...
  return (
    <div className="flex flex-col gap-1 mb-8">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <h1 className="text-2xl font-extrabold text-text-primary tracking-tight">Platform Reports & Analytics</h1>
        <div className="flex items-center gap-3 flex-wrap">
          <div className="flex items-center bg-bg-card border border-border rounded-[var(--radius-md)] p-1 shadow-sm">
          ...
          <button 
            className="inline-flex items-center gap-2 bg-bg-card border border-border text-text-primary hover:bg-bg-input hover:border-primary px-4 py-2.5 rounded-[var(--radius-md)] text-sm font-bold transition-colors" 
            onClick={handleExport}
          >
