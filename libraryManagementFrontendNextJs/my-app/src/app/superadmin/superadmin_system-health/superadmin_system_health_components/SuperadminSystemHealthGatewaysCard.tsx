...
export function SuperadminSystemHealthGatewaysCard({ gateways }: SuperadminSystemHealthGatewaysCardProps) {
  return (
    <div className="col-span-1 md:col-span-2 bg-bg-pageg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {gateways.map((g) => (
          <div key={g.n} className="flex items-center gap-4 bg-bg-pageg-input border border-border p-4 rounded-md shadow-inner transition-colors hover:border-primary">
