...
const MODE_BADGE: Record<string, string> = {
  cash: 'bg-[#134E4A] text-[#5EEAD4] border border-[#134E4A]/20',
  upi:  'bg-[#164E63] text-[#67E8F9] border border-[#164E63]/20',
  card: 'bg-[#1E293B] text-[#94A3B8] border border-[#1E293B]/20',
  bank: 'bg-[#0C4A6E] text-[#38BDF8] border border-[#0C4A6E]/20',
};
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex flex-col justify-center py-1">
                          {p.status === 'valid' ? (
                            <span className="bg-[#064E3B] text-[#34D399] border border-[#34D399]/20 px-2 py-0.5 rounded-full text-xs font-bold self-start uppercase tracking-wider">Valid</span>
                          ) : (
                            <span className="bg-[#450A0A] text-[#F87171] border border-[#F87171]/20 px-2 py-0.5 rounded-full text-xs font-bold self-start uppercase tracking-wider">DELETED</span>
                          )}
                        ...
                        <div className="flex items-center gap-2">
                          {p.status === 'valid' && (
                            <>
                              ...
                              <button
                                className="w-7 h-7 flex items-center justify-center rounded-md bg-[#450A0A] text-[#F87171] border border-[#F87171]/20 hover:bg-danger hover:text-white transition-colors cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-bg-card w-full max-w-md rounded-xl shadow-2xl border border-border p-6 animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex items-center justify-end gap-3 mt-6">
              ...
              <button
                className="bg-[#450A0A] text-[#F87171] border border-[#F87171]/20 px-4 py-2 rounded-md text-sm font-bold hover:bg-danger hover:text-white transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
