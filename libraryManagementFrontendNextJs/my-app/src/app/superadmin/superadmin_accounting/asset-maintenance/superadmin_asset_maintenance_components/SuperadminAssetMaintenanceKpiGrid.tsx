...
export function SuperadminAssetMaintenanceKpiGrid({ pendingCount, inProgressCount, completedCount, totalCost }: Props) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-[var(--info-bg,rgba(59,130,246,0.1))] border border-info,#3B82F6/20 rounded-[var(--radius-lg)] p-4 shadow-sm flex flex-col justify-center">
      ...
      <div className="bg-[var(--success-bg,rgba(52,211,153,0.1))] border border-success/20 rounded-[var(--radius-lg)] p-4 shadow-sm flex flex-col justify-center">
