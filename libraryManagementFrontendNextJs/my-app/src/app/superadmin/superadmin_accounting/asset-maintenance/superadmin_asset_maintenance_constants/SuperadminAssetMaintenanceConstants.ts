...
export const SUPERADMIN_ASSET_MAINTENANCE_MOCK_DATA: SuperadminMaintenanceLog[] = [
  { id: 1, assetName: 'AC Unit â€” Hall A',   issue: 'Gas refill & filter cleaning',  reportedDate: '2026-04-02', scheduledDate: '2026-04-08', vendor: 'CoolTech Services', cost: 1800, status: 'completed'   },
  ...
  { id: 3, assetName: 'CCTV Camera â€” B2',    issue: 'Camera not recording',          reportedDate: '2026-04-08', scheduledDate: '2026-04-12', vendor: 'SecureVision',      cost: 1200, status: 'pending'     },
