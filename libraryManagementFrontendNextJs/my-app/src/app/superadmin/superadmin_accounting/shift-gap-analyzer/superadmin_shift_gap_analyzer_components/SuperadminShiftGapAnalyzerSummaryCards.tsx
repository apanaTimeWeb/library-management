  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      {shifts.map((m) => {
        ...
        return (
          <div key={m.shift} className="bg-bg-card border border-border rounded-[var(--radius-lg)] p-5 shadow-sm space-y-4">
            ...
            <div className="h-2 w-full bg-bg-input rounded-full overflow-hidden border border-border/50">
              <div 
            ...
            <div className="grid grid-cols-3 gap-2 text-center pt-2">
              <div>
                <p className="text-[10px] font-bold text-text-secondary uppercase tracking-wider mb-0.5">Occupied</p>
                <p className="text-lg font-extrabold text-success">{m.occupied}</p>
              </div>
              <div>
                <p className="text-[10px] font-bold text-text-secondary uppercase tracking-wider mb-0.5">Vacant</p>
                <p className="text-lg font-extrabold text-danger">{m.vacant}</p>
              </div>
              <div>
                <p className="text-[10px] font-bold text-text-secondary uppercase tracking-wider mb-0.5">Loss</p>
