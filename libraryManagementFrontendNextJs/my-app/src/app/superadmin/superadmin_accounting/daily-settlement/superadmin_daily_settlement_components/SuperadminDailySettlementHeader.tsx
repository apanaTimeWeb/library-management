  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
      <div className="flex flex-col gap-1">
        <h1 className="text-text-primaryxl font-extrabold text-text-primary tracking-tight">Daily Settlement</h1>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input 
          type="date" 
          className="w-full sm:w-44 bg-bg-pageg-input border border-border rounded-md py-2 px-3 text-sm font-medium text-text-primary focus:outline-none focus:border-primary transition-colors shadow-inner" 
          value={date} 
