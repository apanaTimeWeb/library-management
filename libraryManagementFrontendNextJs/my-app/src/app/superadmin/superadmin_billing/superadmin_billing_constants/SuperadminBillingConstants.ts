// RESPONSIBILITY: Renders or handles logic for SuperadminBillingConstants.ts.
...
export const SUPERADMIN_BILLING_MOCK_INVOICES: SuperadminBillingInvoice[] = [
  ...
  { id: 'REC-2026-0401', tenant: 'Scholar Spaces',        date: '01 Apr, 2026', amount: 999,   status: 'Overdue', method: 'â€”',             gst: '27AABCS1429B1Z6' },
