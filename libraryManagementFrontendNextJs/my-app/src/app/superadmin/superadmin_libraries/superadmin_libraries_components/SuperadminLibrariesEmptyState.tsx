...
export function SuperadminLibrariesEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-64 w-full bg-bg-pageg-card rounded-lg p-8 text-center animate-in fade-in duration-300">
      <div className="w-16 h-16 rounded-full bg-bg-pageg-input flex items-center justify-center mb-4">
