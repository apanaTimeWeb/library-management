...
export function PublicFeaturesGrid() {
  return (
    <section className="py-24 px-6 bg-bg-pageg-card border-y border-border">
          ...
          {PUBLIC_FEATURES.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-bg-pageg-page border border-border rounded-[var(--radius-lg)] p-6 hover:border-primary/50 transition-colors group cursor-default"
              >
