      ...
      <div className="bg-card border border-border rounded-xl shadow-2xl max-w-md w-full p-6 space-y-5">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4">
          <div>
            ...
            <Input type="text" {...register('name')} placeholder="e.g. Study Tables (20)" className="w-full" disabled={isSubmitting} />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input type="date" {...register('purchaseDate')} className="w-full" disabled={isSubmitting} />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <Input type="text" {...register('location')} placeholder="e.g. First Floor" className="w-full" disabled={isSubmitting} />
