...
export const useAdminAccountingStore = create<AdminAccountingStoreState>((set, get) => ({
  ...
  fetchAssets: async () => {
    ...
    try {
      ...
      set({ assets: (((Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])).length > 0) ? (Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])) : (() => { throw new Error('Force Mock'); })()), fetchState: 'success' });
    } catch (e) {
  ...
  fetchExpenses: async () => {
    ...
    try {
      ...
      set({ expenses: (((Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])).length > 0) ? (Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])) : (() => { throw new Error('Force Mock'); })()), fetchState: 'success' });
    } catch (e) {
  ...
  fetchMaintenance: async () => {
    ...
    try {
      ...
      set({ maintenance: (((Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])).length > 0) ? (Array.isArray(data) ? data : (Array.isArray((data as any)?.data) ? (data as any).data : [])) : (() => { throw new Error('Force Mock'); })()), fetchState: 'success' });
    } catch (e) {
