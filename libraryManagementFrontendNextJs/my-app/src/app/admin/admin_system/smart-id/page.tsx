...
import { ADMIN_SYSTEM_SMART_ID_ACTIVE_IDS, ADMIN_SYSTEM_SMART_ID_FLOW_STEPS } from '@/app/admin/admin_system/admin_system_data/AdminSystemMockData';
        ...
        <CardContent>
          ...
          <div className="flex items-center gap-6 text-xs text-on-surface-variant">
            <div className="flex items-center gap-1.5">
              ...
              Active ({ADMIN_SYSTEM_SMART_ID_ACTIVE_IDS.length})
            </div>
            <div className="flex items-center gap-1.5">
