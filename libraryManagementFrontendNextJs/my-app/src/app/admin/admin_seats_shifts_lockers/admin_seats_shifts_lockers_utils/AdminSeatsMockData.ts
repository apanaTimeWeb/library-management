...
export const ADMIN_SEATS_MOCK_LOCKER_LEGEND = [
...
export const ADMIN_SEATS_MOCK_HISTORY = [
...
export const ADMIN_SEATS_MOCK_SHIFT_TABS = ['All', 'Morning', 'Evening', 'Full Day'];

export const ADMIN_SEATS_MOCK_LEGEND_ITEMS = [
  { cls: 'ss-legend-dot--success',     label: 'Free' },
  { cls: 'ss-legend-dot--danger',      label: 'Occupied' },
...
export const ADMIN_SEATS_MOCK_SHIFT_GAPS = [
  {
...
export const ADMIN_SEATS_MOCK_VIEW_PERIODS = ['Today', 'This Week', 'This Month'];

export const ADMIN_SEATS_MOCK_SHIFTS = [
...
export const ADMIN_SEATS_MOCK_STUDENTS = [
...
export const ADMIN_SEATS_MOCK_SHIFT_RATES = [
...
export const ADMIN_SEATS_STEPS = [
