...
import { useShiftMigration, PayMode } from '@/app/admin/admin_seats_shifts_lockers/shift-migration/admin_seats_shifts_lockers_hooks/useShiftMigration';
    ...
    <div className="h-full flex flex-col pb-24 relative">
      ...
      <div className="w-full max-w-3xl mx-auto mb-10 relative">
        <div className="absolute top-1/2 left-0 right-0 h-1 bg-muted -translate-y-1/2 rounded-full overflow-hidden">
          <div className="h-full bg-primary transition-all duration-300" style={{ width: `${((step - 1) / 2) * 100}%` }} />
        </div>
