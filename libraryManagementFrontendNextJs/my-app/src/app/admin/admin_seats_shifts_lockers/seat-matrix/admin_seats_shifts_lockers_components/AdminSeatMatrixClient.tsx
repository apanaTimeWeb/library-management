...
export function AdminSeatMatrixClient() {
  const {
    activeTab,
    setActiveTab,
    selectedSeat,
      ...
      <Card className="flex-1 shadow-sm border-border bg-card flex flex-col min-h-96">
        ...
        <div className="p-5 overflow-auto flex-1 bg-muted/5 flex flex-col">
          {isLoading ? (
            ...
            <div className="grid  gap-3 sm:gap-4 place-content-start w-full grid-cols-[var(--cols)]" style={{ '--cols': "repeat(auto-fill, minmax(50px, 1fr))" } as React.CSSProperties}>
