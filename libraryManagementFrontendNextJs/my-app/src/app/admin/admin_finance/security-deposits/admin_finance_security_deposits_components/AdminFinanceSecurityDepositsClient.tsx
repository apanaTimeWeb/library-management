...
export function AdminFinanceSecurityDepositsClient() {
  ...
  const {
    ...
    handleRefund,
    handleDeduction
  } = useAdminFinanceSecurityDeposits();
  ...
  return (
    <div className="h-full flex flex-col pb-10 space-y-6 relative">
      ...
      {refundDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-bg-pagelack/60 backdrop-blur-sm" onClick={() => setRefundDialog(null)}>
