...
import { useFinanceReceipt, type FilterMode } from '@/app/admin/admin_finance/receipt/admin_finance_receipt_hooks/useFinanceReceipt';
    ...
    <div className="h-full flex flex-col pb-10 space-y-6 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="p-5 shadow-none border-success/30 bg-success/5 flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold tracking-wider uppercase text-success">TOTAL COLLECTED</span>
