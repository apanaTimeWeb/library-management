...
export const ADMIN_FINANCE_MOCK_STUDENTS = [
...
export const ADMIN_FINANCE_MODES = ['cash', 'upi', 'card', 'bank'] as const;

export const ADMIN_FINANCE_MOCK_DASHBOARD_STATS = {
...
export const ADMIN_FINANCE_MOCK_RECENT_PAYMENTS = [
...
export const ADMIN_FINANCE_MOCK_INVOICES = [
...
export const ADMIN_FINANCE_MOCK_LATE_FEES_CONFIG = { gracePeriodDays: 5, penaltyPerDay: 50 };

export const ADMIN_FINANCE_MOCK_LATE_FEES_OVERDUE = [
...
export const ADMIN_FINANCE_MOCK_PAYMENT_PROMISES = [
...
export const ADMIN_FINANCE_MOCK_PAYMENTS = [
...
export const ADMIN_FINANCE_MOCK_RECEIPTS = [
...
export const ADMIN_FINANCE_MOCK_REFERRERS = [
...
export const ADMIN_FINANCE_MOCK_REFUNDS = [
...
export const ADMIN_FINANCE_MOCK_RENEWALS = [
...
export const ADMIN_FINANCE_MOCK_DEPOSITS = [
...
export const ADMIN_FINANCE_MOCK_SUBSCRIPTIONS = [
...
export const ADMIN_FINANCE_MOCK_TRUST_SCORE = [
