...
import { AuthRegisterController } from '@/modules/auth/signup/controllers/auth-register.controller';
import { AuthRegisterService } from '@/modules/auth/signup/services/auth-register.service';
