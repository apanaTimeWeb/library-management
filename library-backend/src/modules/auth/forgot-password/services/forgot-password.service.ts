...
import { AuthForgotPasswordDto } from '@/modules/auth/forgot-password/dto/auth-forgot-password.dto';

@Injectable()
export class AuthForgotPasswordService {
  private readonly logger = new Logger(AuthForgotPasswordService.name);
  ...
  async processForgotPassword(forgotPasswordDto: AuthForgotPasswordDto): Promise<any> {
