...
export class AdminDashboardService {
  ...
  async getDashboardData(): Promise<AdminDashboardData> {
    ...
    const todayCollection = payments.reduce(
      (sum, p) => sum + Number(p.amount),
      0,
    );
    const seats = await this.seatRepo.find();

    const seatData = [{ id: 'S1', shift: 'Morning', status: 'free', fee: 'Paid' }, {
        ...
        id: 'S4', shift: 'Morning', status: 'expiring', fee: 'Due', occupant: 'Amit Verma', expiry: '28/07/25', studentId: '4', }, { id: 'S5', shift: 'Night', status: 'maintenance', fee: 'Paid' }, {
        id: 'S6', shift: 'Evening', status: 'occupied', fee: 'Due', occupant: 'Sneha Rao', expiry: '10/08/25', studentId: '6', }, { id: 'S7', shift: 'Morning', status: 'free', fee: 'Paid' }, { id: 'S8', shift: 'Night', status: 'free', fee: 'Paid' }, { id: 'S9', shift: 'Evening', status: 'free', fee: 'Paid' }, {
        ...
        id: 'S12', shift: 'Evening', status: 'occupied', fee: 'Paid', occupant: 'Rahul Gupta', expiry: '15/08/25', studentId: '12', }, { id: 'S13', shift: 'Morning', status: 'free', fee: 'Paid' }, { id: 'S14', shift: 'Night', status: 'free', fee: 'Paid' }, { id: 'S15', shift: 'Evening', status: 'maintenance', fee: 'Paid' }, {
        id: 'S16', shift: 'Morning', status: 'occupied', fee: 'Due', occupant: 'Pooja Sharma', expiry: '03/08/25', studentId: '16', }, { id: 'S17', shift: 'Morning', status: 'free', fee: 'Paid' }, {
        ...
        id: 'S20', shift: 'Morning', status: 'expiring', fee: 'Due', occupant: 'Vikram Patel', expiry: '29/07/25', studentId: '20', }, { id: 'S21', shift: 'Evening', status: 'free', fee: 'Paid' }, {
        id: 'S22', shift: 'Morning', status: 'occupied', fee: 'Paid', occupant: 'Sanya Dua', expiry: '18/08/25', studentId: '22', }, { id: 'S23', shift: 'Night', status: 'free', fee: 'Paid' }, {
