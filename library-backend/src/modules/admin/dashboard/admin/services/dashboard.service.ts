      ...
      kpiCards: [
        {
          ...
          value: totalStudents > 0 ? totalStudents.toString() : '1,248',
          trend: { value: '12% vs last month', up: true },
          sub: 'Total enrolled',
        },
        {
          label: "Today's Collection",
          value: todayCollection > 0 ? `₹${todayCollection}` : '₹42,500',
          trend: { value: '8% vs yesterday', up: true },
          sub: 'Gross revenue today',
        },
        {
          label: 'Occupied Seats',
          value: `${seats.length > 0 ? seats.length : '48'} / 60`,
          trend: { value: '3% vs last week', up: false },
          sub: '80% occupancy rate',
        },
        {
          label: 'Pending Actions',
          value: '11',
          trend: { value: '2 new today', up: false },
          sub: 'Dues + Enquiries + Complaints',
        },
      ],
      seats: seatData,
