...
import { DashboardAuditLogsService } from '@/modules/admin/dashboard-audit-logs/dashboard/services/audit-logs.service';
...
export class DashboardAuditLogsController {
  constructor(private readonly auditLogsService: DashboardAuditLogsService) {}
